...
python -u run.py \
    --config-name=config_construction_cost_finetune \
    finetune=True \
    checkpoint=/hdd/hiep/CODE/Construction_Cost_Prediction/work_dir/runs/pretrain/tip_pretrain_construction_cost_1221_2023/checkpoint_best_rmsle_44_0.2466.ckpt
```
