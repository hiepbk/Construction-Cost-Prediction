...
python evaluate_construction_cost.py \
    --checkpoint /hdd/hiep/CODE/Construction_Cost_Prediction/work_dir/runs/finetune/tip_finetune_construction_cost_1221_1305/fold_3/checkpoint_best_rmsle.ckpt \
