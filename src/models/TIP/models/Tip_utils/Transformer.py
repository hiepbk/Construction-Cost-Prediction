...
class MultimodalTransformerEncoder(nn.Module):
    ...
    def __init__(self, args: Dict) -> None:
        ...
        # Use actual image encoder output dimension (pooled_dim) instead of embedding_dim
        # embedding_dim is the projection head output, but we receive raw encoder output
        image_input_dim = getattr(args, 'image_encoder_output_dim', args.embedding_dim)
        self.image_proj = nn.Linear(image_input_dim, args.multimodal_embedding_dim)
